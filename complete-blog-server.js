...
let users = [
  { id: 1, username: 'drjohn', full_name: 'Dr. John Smith', email: 'drjohn@test.com', password: '\\\\\\', role: 'doctor' },
  { id: 2, username: 'patient1', full_name: 'Jane Doe', email: 'jane@test.com', password: '\\\\\\', role: 'patient' }
];
...
app.post('/api/blog/posts', authenticateToken, upload.single('image'), (req, res) => {
  ...
  const newPost = {
    ...
    image_url: req.file ? /uploads/blog-images/\ : null,
